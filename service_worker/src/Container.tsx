...
import { Radio as ChakraRadio, Select as ChakraSelect } from '@chakra-ui/react';
...
export const StyledRadio = styled(ChakraRadio)` 
  span:last-child {
    font-size: 14px;
    font-weight: 300;
    font-family: Helvetica, "Noto Sans JP", sans-serif;
...
export const StyledSelect = styled(ChakraSelect)`
