...
export function init() {
    ...
    if (!ghoustFrame) {
        ...
        ghoustFrame.style.cssText = "position: fixed; display: block; width: 100%; height: 100%; top: 0; left: 0; right: 0; bottom: 0; background-color: rgba(0,0,0,0); z-index: calc(9e999); cursor: crosshair;"
    ...
    if (topFrame === null) {
        ...
        topFrame.style.cssText = `background-color: rgba(0,0,0,0.5); z-index: calc(9e999); cursor: inherit;`
    ...
    if (bottomFrame === null) {
        ...
        bottomFrame.style.cssText = `background-color: rgba(0,0,0,0.5); z-index: calc(9e999); cursor: inherit;`
    ...
    if (leftFrame === null) {
        ...
        leftFrame.style.cssText = `background-color: rgba(0,0,0,0.5); z-index: calc(9e999); cursor: inherit;`
    ...
    if (rightFrame === null) {
        ...
        rightFrame.style.cssText = `background-color: rgba(0,0,0,0.5); z-index: calc(9e999); cursor: inherit;`
    ...
    if (zoneFrame === null) {
        ...
        zoneFrame.style.cssText = `background-color: rgba(0,0,0,0); z-index: calc(9e999); cursor: inherit;`
