...
export const ButtonColumn = styled.div`
  ...
  export const SaveCloseDiv = styled.div<{ input: boolean }>`
  display: grid;
  grid-area: '1 / 1';
  ...
  export const EditDiv = styled.div<{ input: boolean }>`
  display: grid;
  grid-area: '1 / 1';
  ...
  export const EditSpan = styled.span<{ input: boolean }>`
  display: inline-block;
  transition : opacity 0.3s ease-in-out;
  opacity: ${(props) => props.input === false ? '1' : '0'};
  `;

  export const SaveCloseSpan = styled.span<{ input: boolean }>`
  text-align: end;
  transition : opacity 0.3s ease-in-out;
  ...
  export const KanjiStatDiv = styled.div<{ dropdown: number | null, index: number }>`
  ...
  export const NotificationDiv = styled.div<{ notification: { message: string; id: number } | null, fade: boolean, err: boolean }>`
  border-radius: 5px;
  margin: 5px;
  text-align: center;
  position: absolute;
